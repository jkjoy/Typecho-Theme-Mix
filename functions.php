...
function themeConfig($form) {
    ...
    $bgcolor = new Typecho_Widget_Helper_Form_Element_Text('bgcolor', NULL, '#f8f9fa', _t('背景颜色'), _t('文章区域背景颜色'));
    $form->addInput($bgcolor);
    $textcolor = new Typecho_Widget_Helper_Form_Element_Text('textcolor', NULL, '#333333', _t('文字颜色'), _t('导航栏鼠标悬停时文字颜色'));
    $form->addInput($textcolor);
    $primarycolor = new Typecho_Widget_Helper_Form_Element_Text('primarycolor', NULL, '#333333', _t('主色调'), _t('头部区域文字主色调'));
    $form->addInput($primarycolor);
    $secondarycolor = new Typecho_Widget_Helper_Form_Element_Text('secondarycolor', NULL, '#2ecc71', _t('次色调'), _t('联系方式区域鼠标悬停文字颜色'));
    $form->addInput($secondarycolor);
    $typecolor = new Typecho_Widget_Helper_Form_Element_Text('typecolor', NULL, '#f7dc6f', _t('类型颜色'), _t('文章分类文字颜色'));
    $form->addInput($typecolor);
    $boxcolor = new Typecho_Widget_Helper_Form_Element_Text('boxcolor', NULL, '#f7dc6f', _t('盒子颜色'), _t('盒子颜色'));
    $form->addInput($boxcolor);
    ...
    $customtitle = new Typecho_Widget_Helper_Form_Element_Text('customtitle', NULL, NULL, _t('自定义标题'), _t('会在文章列表上方显示'));
    $form->addInput($customtitle);
    $customdescription = new Typecho_Widget_Helper_Form_Element_Textarea('customdescription', NULL, NULL, _t('自定义描述'), _t('会在文章列表上方显示'));
